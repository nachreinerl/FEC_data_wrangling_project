...
```
  ...
  Another aspect of this data that I investigated further was beginning cash and candidate type (challenger, incumbent, or the case where the seat was open). In the graph above, it is evident that in general, incumbents start with a much higher amount of money than challengers do. Additionally, I saw that there were some incumbents who started their campaigns with well upwards of \$1,000,000, while no challengers started with above \$500,0000. Something that surprised me, however, is that within each candidate type, the beginning cash for the democrats and republicans was extremely similar. This was interesting to us because this seems to go against the message pushed by many democrats that they value distributing money more equally among the population. Finally, this shows that once one is in power, it is much easier to raise money and thus be better equipped to run a good campaign and stay in power.
